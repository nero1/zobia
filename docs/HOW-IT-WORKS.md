...
**Android:** group chats are not yet ported to the Capacitor app (still true as of v2.18 — see the "Not yet done (Android user pages)" list above). The DM fix and Inbox→Announcements rename in the same v2.18 pass ARE mirrored on Android.
