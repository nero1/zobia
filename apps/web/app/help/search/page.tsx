  ...
  return (
    <main id="main-content" className="min-h-screen bg-background">
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <h1 className="mt-2 mb-6 text-2xl font-bold">{t("help.searchResults")}{q ? ` for "${q}"` : ""}</h1>

        <HelpSearchBox />

        <div className="mt-8 space-y-3">
          {q && results.length === 0 && <p className="text-sm text-muted-foreground">{t("help.noResults")}</p>}
          {results.map((r) => (
