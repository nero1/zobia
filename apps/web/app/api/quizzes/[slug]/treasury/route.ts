 ...
 * POST /api/quizzes/:slug/treasury — the quiz's own creator funds (or tops
 *   up), debited from their own Credits balance, the pot that the first
 *   `maxClaimants` users who PASS split evenly.
