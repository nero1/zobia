 ...
 *
 * Currency refunds management page for the admin panel (currency display
 * name is admin-configurable — see lib/hooks/useCurrency.ts).
 * Lists soft-currency purchase transactions and processed refunds.
...
export default function AdminRefundsPage() {
  ...
  return (
    <div className="relative">
      ...
      <h1 className="mb-6 text-2xl font-bold text-neutral-900 dark:text-neutral-50">{currency.softPlural} Refunds</h1>
                ...
                filtered.map((r) => (
                  <tr key={r.id} className="hover:bg-neutral-50 dark:hover:bg-neutral-800/50">
                    ...
                    <td className="px-4 py-3 tabular-nums font-semibold text-amber-600 dark:text-amber-400">
                      {r.amount_coins.toLocaleString()} {currency.softPlural.toLowerCase()}
                    </td>
