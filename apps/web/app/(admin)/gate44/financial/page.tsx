...
function EconomyBar({ economy, currencyPlural }: { economy: CoinEconomy; currencyPlural: string }) {
  ...
  return (
    <div className="rounded-xl border border-neutral-200 bg-white p-5 dark:border-neutral-800 dark:bg-neutral-900">
      <h2 className="mb-4 text-sm font-semibold text-neutral-700 dark:text-neutral-300">{currencyPlural} Economy (30-day)</h2>
    ...
    <div className="relative space-y-6">
      ...
      {loading ? (
        ...
        <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
          ...
          />
          <SummaryCard
            label={`Users With ${currency.softPlural}`}
      ...
      {loading ? (
        ...
        <EconomyBar economy={data.coinEconomy} currencyPlural={currency.softPlural} />
      ) : null}
      ...
      <div className="rounded-xl border border-neutral-200 bg-white shadow-card dark:border-neutral-800 dark:bg-neutral-900">
        <div className="border-b border-neutral-200 px-5 py-4 dark:border-neutral-800">
          ...
          <p className="text-xs text-neutral-500">
            ...
            <a href="/gate44/config" className="text-primary-600 hover:underline">Config → Creator Fund</a>.
          </p>
        </div>
