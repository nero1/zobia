    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-4 text-sm font-medium">
          <Link href="/gate44/business/pages" className="text-neutral-600 hover:underline dark:text-neutral-400">Business Pages →</Link>
          <Link href="/gate44/sponsored-quests" className="text-neutral-600 hover:underline dark:text-neutral-400">Ads Moderation (Sponsored Quests) →</Link>
        </div>
      </div>
