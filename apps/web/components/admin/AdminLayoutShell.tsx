...
const adminNavItems = [
  ...
  { href: "/gate44/moderation/roster",   label: "Moderation Roster",   icon: "👮" },
  { href: "/gate44/moderation/appeals",  label: "Account Appeals",     icon: "📨" },
  ...
  { href: "/gate44/gifts/message-settings", label: "Gift Message Settings", icon: "💬" },
  { href: "/gate44/market",             label: "Market Curation",    icon: "🏪" },
  ...
  { href: "/gate44/ads/moderation-queue", label: "Ad Moderation Queue", icon: "🕵️" },
