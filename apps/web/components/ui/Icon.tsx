 ...
 * chrome (top bar, bottom tab bar, side drawer/menu, profile dropdown) has
 * been converted to use <Icon>. The rest of the app (post reactions, gift
 * emojis, badges, achievement icons, etc.) still uses raw emoji characters
 * directly in JSX, and that is intentional — not an oversight to "finish
 * later" by grep-replacing every emoji in the codebase. A future task may
 * extend the <Icon> vocabulary to more surfaces, but should treat every
 * emoji outside nav chrome as deliberately out of scope unless told
 * otherwise.
 *
