...
-- NOTE: x_manifest.value is JSONB NOT NULL. Every non-numeric, non-boolean
-- value below must be a JSON string literal (double-quoted) — a bare SQL
-- string like 'none' is not valid JSON and this whole multi-row INSERT
-- fails atomically (aborting the rest of this migration file) if any one
-- row is invalid. True/false/integers are valid JSON scalars as-is.
