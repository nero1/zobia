...
export const brandedRooms = pgTable("branded_rooms", {
  ...
  sponsorBudgetCoins: bigint("sponsor_budget_coins", { mode: "bigint" }).notNull().default(BigInt(0)),
...
export const giftItems = pgTable("gift_items", {
  ...
  name: text("name").notNull().unique(),
  emoji: text("emoji").notNull(),
  coinCost: bigint("coin_cost", { mode: "bigint" }).notNull().default(BigInt(0)),
...
export const failedCommissions = pgTable("failed_commissions", {
  ...
  userId: uuid("user_id").notNull(),
  coinAmount: bigint("coin_amount", { mode: "bigint" }).notNull(),
  amountKobo: bigint("amount_kobo", { mode: "bigint" }).notNull().default(BigInt(0)),
