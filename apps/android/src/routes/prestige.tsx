  ...
  return (
    <div className="flex flex-col items-center py-12 px-6 text-center">
      ...
      <p className="mt-2 text-neutral-500 dark:text-neutral-400">
        ...
        <span className="font-semibold text-neutral-900 dark:text-neutral-100">{data.currentRank.rankName || 'Beginner'}</span>{' '}
        (Level {currentLevel}).
      </p>
      ...
      <div className="mt-6 w-full max-w-xs">
        <div className="mb-1 flex justify-between text-xs text-neutral-400 dark:text-neutral-500">
      ...
      <Link to="/profile" className="mt-8 rounded-xl border border-neutral-300 dark:border-neutral-600 px-6 py-2.5 text-sm font-semibold text-neutral-700 dark:text-neutral-300">
  ...
  return (
    <div className="space-y-5 px-4 py-4">
      ...
      <div className="rounded-xl border border-amber-200 bg-amber-50 dark:bg-amber-900/30 p-4">
        <h3 className="mb-2 text-sm font-semibold text-amber-700 dark:text-amber-300">{t('prestige.prestigeRewards', 'Prestige Rewards')}</h3>
      ...
      <div className="flex gap-3">
        ...
        <Link to="/profile" className="flex-1 rounded-xl border border-neutral-300 dark:border-neutral-600 py-3 text-center font-semibold text-neutral-700 dark:text-neutral-300">
  ...
  return (
    <div className="h-full overflow-y-auto bg-neutral-50 dark:bg-neutral-800">
      <div className="px-4 pt-4">
        <h1 className="text-xl font-bold text-neutral-900 dark:text-neutral-100">{t('prestige.title', 'Prestige')}</h1>
        <div className="mt-3 rounded-xl border border-blue-200 bg-blue-50 dark:bg-blue-900/30 p-4">
