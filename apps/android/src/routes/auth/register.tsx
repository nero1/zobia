 ...
 *
 * Register screen. Validates with RegisterRequestSchema.
...
import { RegisterRequestSchema } from '@zobia/shared/schemas/auth';
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder={t('android.auth.usernamePlaceholder')}
          ...
          >
            {loading ? t('action.loading') : t('android.auth.registerButton')}
          </button>
        </form>

        <p className="text-center text-sm text-neutral-500 mt-6">
          <Link to="/auth/login" className="text-primary-600 font-medium">
            {t('android.auth.hasAccount')}
          </Link>
        </p>
      </div>
    </div>
