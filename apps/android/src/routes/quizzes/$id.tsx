/**
 * apps/android/src/routes/quizzes/$id.tsx
 *
 * Id-based redirect shim for quiz deep links from the Home Feed (see
 ...
 * shim (apps/web/app/(app)/quizzes/[id]/page.tsx) via the in-app Browser,
...
function QuizRedirect() {
  ...
  useEffect(() => {
    ...
    void Browser.open({ url: `${env.VITE_WEB_BASE_URL}/quizzes/${id}` }).finally(() => {
