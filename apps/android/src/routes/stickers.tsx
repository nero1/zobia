...
function StickersPage() {
  ...
  return (
    <div className="h-full overflow-y-auto bg-neutral-50 dark:bg-neutral-800 space-y-3 px-4 py-4">
      <div>
        <h1 className="text-xl font-bold text-neutral-900 dark:text-neutral-100">{t('stickers.title', 'Sticker Store')}</h1>
        <p className="mt-0.5 text-sm text-neutral-500 dark:text-neutral-400">{t('stickers.subtitle', 'Unlock sticker packs to use in messages and rooms')}</p>
      </div>
