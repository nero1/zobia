...
function CreateMomentPage() {
  ...
  return (
    <div className="h-full overflow-y-auto bg-neutral-50 dark:bg-neutral-800 p-4 space-y-4">
      <h1 className="text-lg font-bold text-neutral-900 dark:text-neutral-100">{t('moments.create.title')}</h1>
      ...
      <div className="bg-white dark:bg-neutral-800 rounded-xl shadow-card">
        ...
        {optionalExpanded && (
          <div className="space-y-4 p-4">
            <div>
              <label className="mb-1 block text-xs font-semibold text-neutral-700 dark:text-neutral-300">{t('moments.create.image')}</label>
            ...
            <div>
              <label className="mb-1 block text-xs font-semibold text-neutral-700 dark:text-neutral-300">{t('moments.create.caption')}</label>
              <input
                type="text"
                value={caption}
      ...
      {!momentsConfig.isFree && (
        <div className="flex flex-wrap items-center justify-between gap-2 rounded-xl border border-amber-200 bg-amber-50 dark:bg-amber-900/30 px-4 py-3">
          ...
          {bothCurrenciesAvailable && (
            <div className="flex overflow-hidden rounded-lg border border-amber-300">
              <button
                ...
                className={`px-2.5 py-1 text-xs font-semibold ${payCurrency === 'credits' ? 'bg-amber-500 text-white' : 'bg-white dark:bg-neutral-800 text-amber-700 dark:text-amber-300'}`}
              >
                {currency.softPlural}
              </button>
              <button
                ...
                className={`px-2.5 py-1 text-xs font-semibold ${payCurrency === 'stars' ? 'bg-amber-500 text-white' : 'bg-white dark:bg-neutral-800 text-amber-700 dark:text-amber-300'}`}
              >
      ...
      <div className="flex gap-3">
        <Link to="/moments" className="flex-1 rounded-xl border border-neutral-300 dark:border-neutral-600 py-2.5 text-center text-sm font-semibold text-neutral-700 dark:text-neutral-300">
