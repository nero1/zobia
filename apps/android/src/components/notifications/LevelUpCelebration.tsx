/**
 * apps/android/src/components/notifications/LevelUpCelebration.tsx
 *
 * Mirrors apps/web/components/celebrations/LevelUpCelebration.tsx — full
 * screen confetti + rank card + short synthetic fanfare (Web Audio). Fired
 * from FloatingRewardProvider when a `reward_earned` realtime event of type
 * "rank_up" arrives on the user's channel (see lib/xp/safeAwardXP.ts on the
 * server — the actual production XP-award path).
 */
...
export function LevelUpCelebration({ data, onDone }: { data: LevelUpCelebrationData; onDone: () => void }) {
