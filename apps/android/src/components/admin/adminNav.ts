...
export const adminNavItems: AdminNavItem[] = [
  ...
  { href: '/admin/moderation-roster', labelKey: 'admin.nav.moderationRoster', labelDefault: 'Moderation Roster', icon: '👮' },
  ...
  { href: '/admin/ai-monitoring', labelKey: 'admin.nav.aiMonitoring', labelDefault: 'AI Monitoring', icon: '🩻' },
  ...
  { href: '/admin/gift-message-settings', labelKey: 'admin.nav.giftMessageSettings', labelDefault: 'Gift Message Settings', icon: '💬' },
  ...
  { href: '/admin/profile-themes', labelKey: 'admin.nav.profileThemes', labelDefault: 'Profile Themes', icon: '🎨' },
  { href: '/admin/ads', labelKey: 'admin.nav.ads', labelDefault: 'Ads', icon: '🖼️' },
  { href: '/admin/ads-moderation-queue', labelKey: 'admin.nav.adModerationQueue', labelDefault: 'Ad Moderation Queue', icon: '🕵️' },
  ...
  { href: '/admin/wiki', labelKey: 'admin.nav.wiki', labelDefault: 'Wiki', icon: '📖' },
  { href: '/admin/support', labelKey: 'admin.nav.support', labelDefault: 'Support Tickets', icon: '🎫' },
  { href: '/admin/help-center', labelKey: 'admin.nav.helpCenter', labelDefault: 'Help Center', icon: '📚' },
];
