...
function LeaderboardSkeleton() {
  return (
    <div className="animate-pulse rounded-xl border border-neutral-200 bg-white p-5 shadow-sm">
      ...
      <div className="mb-1 h-8 w-32 rounded bg-neutral-200" />
  ...
  return (
    <div className="rounded-xl border border-neutral-200 bg-white p-5 shadow-sm">
      ...
      <div className="flex items-end gap-2">
        <p className="text-3xl font-bold text-neutral-900">#{position.rank.toLocaleString()}</p>
      ...
      <Link to="/leaderboards" className="mt-3 block text-xs font-semibold text-primary-600">
